            ...
            <div className="space-y-5 sm:space-y-6 md:space-y-8">
              ...
              <div>
                ...
                <div className="relative bg-gray-100 rounded-[50px] border border-gray-200 grid grid-cols-4 p-1 overflow-hidden">
                  ...
                  {[
                    ...
                    >
                      <span className="text-xs xs:text-sm sm:text-base md:text-lg">{type.icon}</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xs:gap-5 sm:gap-6">
                ...
                <div>
                  ...
                  <div className={`relative bg-gray-100 rounded-[50px] border flex overflow-hidden ${
                    ...
                    {["Onsite", "Remote", "Hybrid"].map((type) => (
                      ...
                      >
                        {type === "Onsite" && <FaBuilding className="text-xs xs:text-sm sm:text-base" />}
                        {type === "Remote" && <FaHome className="text-xs xs:text-sm sm:text-base" />}
                        {type === "Hybrid" && <FaFlag className="text-xs xs:text-sm sm:text-base" />}
                        {type}
                      </button>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <FaDollarSign className={`absolute left-3 xs:left-4 top-1/2 -translate-y-1/2 text-sm xs:text-base ${
                  ...
                  {errors.minimumSalary && (
                    <p className="text-red-500 text-xs mt-1">Please enter a valid salary amount</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xs:gap-5 sm:gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <FaCity className={`absolute left-3 xs:left-4 top-1/2 -translate-y-1/2 text-sm xs:text-base ${
                  ...
                  {errors.city && (
                    <p className="text-red-500 text-xs mt-1">Please enter your city</p>
                  )}
                </div>
