    ...
    <div className="bg-[#F9FAFB] min-h-screen font-sans text-[#1E293B]">
      ...
      <div className="max-w-5xl mx-auto px-4 xs:px-6 sm:px-8 md:px-10 lg:px-0 py-4 sm:py-6 md:py-8">
        ...
        <div className="flex flex-col xs:flex-row justify-between items-start xs:items-center gap-3 xs:gap-0 px-2 mb-4 sm:mb-6">
          <h2 className="text-lg sm:text-xl font-bold text-[#163D5C]">
            Available Jobs
          </h2>
          ...
          {loading ? (
            ...
            filteredJobs.map((job) => {
              ...
              return (
                <div
                  key={job.id}
                  className={`rounded-2xl sm:rounded-[32px] p-4 xs:p-5 sm:p-6 md:p-8 border bg-white transition-all shadow-sm hover:shadow-md ${
                    isMatch ? "border-blue-200 bg-blue-50/5" : "border-gray-50"
                  }`}
                >
