...
export default function RegistrationForm() {
  ...
  // YANGILANDI: Parol validatsiyasi (kamida 6 ta belgi + KATTA harf + raqam)
  const validatePassword = (password) => {
    const hasLength = password.length >= 6;
    const hasUpperCase = /[A-Z]/.test(password); // Kamida 1 ta KATTA harf
    const hasNumber = /\d/.test(password); // Kamida 1 ta raqam
  ...
  // Sana validatsiyasi (kamida 14 yosh)
  ...
  const validateForm = () => {
    ...
    // YANGILANDI: Parol xatolik xabarlari (Katta harf tekshiruvi qo'shildi)
    if (!formData.password) {
      ...
      if (formData.password.length < 6) {
        ...
        // YANGI: Katta harf bo'lmasa chiqadigan xatolik
        ...
        errors.password = "Parol talablarga javob bermaydi";
      }
      isValid = false;
    }

    // Tug'ilgan sana xatolik xabari (14 yosh)
    if (!formData.date_of_birth) {
      errors.date_of_birth = "Tug'ilgan sanani kiriting";
      isValid = false;
    } else if (!validateDateOfBirth(formData.date_of_birth)) {
      errors.date_of_birth = "Siz kamida 14 yoshda bo'lishingiz kerak";
      isValid = false;
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2">
                  Password
                  <span className="text-red-500 ml-1">*</span>
                  {/* YANGILANDI: Hint text */}
                  <span className="text-xs text-gray-500 ml-2">
                    (min 6, katta harf va raqam)
                  </span>
                </label>
                <div className="relative">
                  <FaLock
