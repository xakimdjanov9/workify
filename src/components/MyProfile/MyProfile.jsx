          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div className="relative inline-block mt-4">
                <div
                  className={`w-28 h-28 rounded-full overflow-hidden border-4 shadow-lg mx-auto ${isDark ? "border-gray-800 bg-gray-900" : "border-white bg-gray-50"}`}
                >
                  <img
              ...
              <form onSubmit={handleUpdate} className="space-y-6">
                ...
                {activeModal === "skills" && (
                  <div className="space-y-6">
                    ...
                    <div
                      className={`border-t pt-6 ${isDark ? "border-gray-800" : "border-gray-100"}`}
                    >
                      <div className="flex justify-between mb-4">
                      ...
                      {formData.language?.map((l, i) => (
                        <div key={i} className="flex gap-2 mb-2">
                          <input
                            ...
                            className={`flex-1 p-3 rounded-xl border outline-none ${isDark ? "bg-[#252525] border-gray-700 text-white" : "bg-gray-50 border-gray-200"}`}
                          />
                          <select
                            value={l.level}
                            onChange={(e) =>
                            ...
                            className={`p-3 rounded-xl border outline-none ${isDark ? "bg-[#252525] border-gray-700 text-white" : "bg-gray-50 border-gray-200"}`}
                          >
